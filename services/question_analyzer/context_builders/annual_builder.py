"""Context builder for ANNUAL_SUMMARY financial data requirement."""

from .base import ContextBuilder, ContextBuilderInput
from .components import PromptComponents


class AnnualContextBuilder(ContextBuilder):
    """Builds context for questions requiring annual report analysis."""

    def build(self, input: ContextBuilderInput) -> str:
        """Build context for annual financial report analysis."""
    ...
    def _build_short_analysis(self, input: ContextBuilderInput) -> str:
        ...
        # Extract filing URL from annual statement
        filing_url = None
        if input.annual_statements and len(input.annual_statements) > 0:
            filing_url = input.annual_statements[0].get("filing_10k_url")

        filing_context = f"Annual Report URL: {filing_url}" if filing_url else "No filing URL available"
        ...
        return f"""
            ...
            **Instructions for your analysis:**
            ...
            Analyze the annual report available at the URL provided above and organize your findings into focused sections. 
    ...
    def _build_deep_analysis(self, input: ContextBuilderInput) -> str:
        ...
        return f"""
            ...
            **Instructions for your analysis:**
            ...
            Analyze the annual report available at the URL provided above and provide a comprehensive, detailed analysis. 
            If the URL is accessible, use it as your ONLY source of information. Do not search for additional data sources. This is critical.
