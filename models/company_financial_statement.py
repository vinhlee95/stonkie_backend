from sqlalchemy import Column, Integer, String, JSON, DateTime, Boolean, UniqueConstraint, Text
...
class CompanyFinancialStatement(Base):
    ...
    __table_args__ = (
        UniqueConstraint('company_symbol', 'period_end_year', 
                        name='uq_company_financial_symbol_year'),
    )
